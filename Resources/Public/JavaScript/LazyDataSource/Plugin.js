...
/***/ "./src/Editors/DataSourceMultiSelectEditor.js":
/*!****************************************************!*\
  !*** ./src/Editors/DataSourceMultiSelectEditor.js ***!
  \****************************************************/
/*! no static exports found */
...
var _lazyDataSourceDataLoader = __webpack_require__(/*! ./lazyDataSourceDataLoader */ "./src/Editors/lazyDataSourceDataLoader.js");

var _lazyDataSourceDataLoader2 = _interopRequireDefault(_lazyDataSourceDataLoader);
...
var DataSourceMultiSelectEditor = (_dec = (0, _neosUiDecorators.neos)(function (globalRegistry) {
    return {
        i18nRegistry: globalRegistry.get('i18n')
    };
}), _dec2 = (0, _lazyDataSourceDataLoader2.default)({ isMulti: true }), _dec(_class = _dec2(_class = (_temp2 = _class2 = function (_PureComponent) {
    _inherits(DataSourceMultiSelectEditor, _PureComponent);

    function DataSourceMultiSelectEditor() {
        var _ref;

        var _temp, _this, _ret;

        _classCallCheck(this, DataSourceMultiSelectEditor);

        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
        }

        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = DataSourceMultiSelectEditor.__proto__ || Object.getPrototypeOf(DataSourceMultiSelectEditor)).call.apply(_ref, [this].concat(args))), _this), _this.handleValueChange = function (value) {
            _this.props.commit(value);
        }, _temp), _possibleConstructorReturn(_this, _ret);
    }

    _createClass(DataSourceMultiSelectEditor, [{
        key: 'render',
        value: function render() {
            var _props = this.props,
                ...
                value = _props.value,
                displayLoadingIndicator = _props.displayLoadingIndicator,
            ...
            return _react2.default.createElement(_reactUiComponents.MultiSelectBox, {
                className: className,
...
var DataSourceSelectEditor = (_dec = (0, _neosUiDecorators.neos)(function (globalRegistry) {
    return {
        i18nRegistry: globalRegistry.get('i18n')
    };
}), _dec2 = (0, _lazyDataSourceDataLoader2.default)({ isMulti: false }), _dec(_class = _dec2(_class = (_temp2 = _class2 = function (_PureComponent) {
    _inherits(DataSourceSelectEditor, _PureComponent);

    function DataSourceSelectEditor() {
        var _ref;

        var _temp, _this, _ret;

        _classCallCheck(this, DataSourceSelectEditor);

        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
        }

        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = DataSourceSelectEditor.__proto__ || Object.getPrototypeOf(DataSourceSelectEditor)).call.apply(_ref, [this].concat(args))), _this), _this.handleValueChange = function (value) {
            _this.props.commit(value);
        }, _temp), _possibleConstructorReturn(_this, _ret);
    }

    _createClass(DataSourceSelectEditor, [{
        key: 'render',
        value: function render() {
            var _props = this.props,
                className = _props.className,
...
exports.default = DataSourceSelectEditor;

/***/ }),

/***/ "./src/Editors/lazyDataSourceDataLoader.js":
/*!*************************************************!*\
  !*** ./src/Editors/lazyDataSourceDataLoader.js ***!
  \*************************************************/
/*! no static exports found */
...
exports.default = function (_ref) {
    ...
    return function (WrappedComponent) {
        ...
        var LazyDataSourceDataLoader = (_dec = (0, _neosUiDecorators.neos)(function (globalRegistry) {
            return {
            ...
            _inherits(LazyDataSourceDataLoader, _PureComponent);

            function LazyDataSourceDataLoader() {
                var _ref2;

                var _temp, _this, _ret;

                _classCallCheck(this, LazyDataSourceDataLoader);

                for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
                    args[_key] = arguments[_key];
                }

                return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref2 = LazyDataSourceDataLoader.__proto__ || Object.getPrototypeOf(LazyDataSourceDataLoader)).call.apply(_ref2, [this].concat(args))), _this), _this.state = {
                    isLoading: false,
                    options: [],
                    searchOptions: [],
                    results: []
                }, _this.resolveValue = function () {
                    var valueProvided = isMulti ? Array.isArray(_this.props.value) : _this.props.value;
                    if (valueProvided) {
                        _this.setState({ isLoading: true });
                        var resolver = isMulti ? _this.props.lazyDataSourceDataLoader.resolveValues.bind(_this.props.lazyDataSourceDataLoader) : _this.props.lazyDataSourceDataLoader.resolveValue.bind(_this.props.lazyDataSourceDataLoader);
                        resolver(_this.getDataLoaderOptions(), _this.props.value).then(function (options) {
                            _this.setState({
                                isLoading: false,
                                options: options
                            });
                    ...
                    if (searchTerm) {
                        _this.setState({ isLoading: true, searchOptions: [] });
                        _this.props.lazyDataSourceDataLoader.search(_this.getDataLoaderOptions(), searchTerm).then(function (searchOptions) {
                            _this.setState({
                                isLoading: false,
                                searchOptions: searchOptions
                            });
            ...
            _createClass(LazyDataSourceDataLoader, [{
                ...
                key: 'getDataLoaderOptions',
                value: function getDataLoaderOptions() {
                    return {
...
var _hashlru = __webpack_require__(/*! hashlru */ "./node_modules/hashlru/index.js");
...
var _DataSourceMultiSelectEditor = __webpack_require__(/*! ./Editors/DataSourceMultiSelectEditor */ "./src/Editors/DataSourceMultiSelectEditor.js");

var _DataSourceMultiSelectEditor2 = _interopRequireDefault(_DataSourceMultiSelectEditor);

var _DataSourceSelectEditor = __webpack_require__(/*! ./Editors/DataSourceSelectEditor */ "./src/Editors/DataSourceSelectEditor.js");

var _DataSourceSelectEditor2 = _interopRequireDefault(_DataSourceSelectEditor);
...
(0, _neosUiExtensibility2.default)('Sandstorm.LazyDataSource:Plugin', {}, function (globalRegistry, _ref) {
    ...
    dataLoadersRegistry.set('SandstormLazyDataSourceLoader', {
        ...
        _lru: function _lru() {
            if (!this._lruCache) {
                this._lruCache = new _hashlru2.default(500);
            }
            return this._lruCache;
        },
        resolveValue: function resolveValue(options, identifier) {
        ...
        resolveValues: function resolveValues(options, identifiers) {
            var _this = this;

            var resultPromisesByIdentifier = {};
            var identifiersNotInCache = [];

            identifiers.forEach(function (identifier) {
                var cacheKey = makeCacheKey('resolve', { options: options, identifier: identifier });

                if (_this._lru().has(cacheKey)) {
                    resultPromisesByIdentifier[identifier] = _this._lru().get(cacheKey);
                } else {
            ...
            if (identifiersNotInCache.length > 0) {
                ...
                // Trigger query
                var dataSourceApi = _neosUiBackendConnector2.default.get().endpoints.dataSource;
                result = dataSourceApi(options.dataSourceIdentifier, options.dataSourceUri, params).then(function (results) {
                    var resultsAsArray = Object.keys(results).map(function (identifier) {
                        return _extends({}, results[identifier], {
                            value: identifier
                        });
                    });
                    ...
                    return Promise.all(identifiers.map(function (identifier) {
        ...
        search: function search(options, searchTerm) {
            var _this2 = this;
            ...
            var cacheKey = makeCacheKey('search', { options: options, searchTerm: searchTerm });
            ...
            return new Promise(function (resolve) {
                if (_this2._debounceTimer) {
                    window.clearTimeout(_this2._debounceTimer);
                }
                ...
                // Trigger query
                var dataSourceApi = _neosUiBackendConnector2.default.get().endpoints.dataSource;
                var resultPromise = dataSourceApi(options.dataSourceIdentifier, options.dataSourceUri, searchQuery).then(function (results) {
                    return Object.keys(results).map(function (identifier) {
                        return _extends({}, results[identifier], {
                            value: identifier
                        });
                    });
